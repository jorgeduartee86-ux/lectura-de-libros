...
select has_trigger('public', 'relationship_members', 'relationship_max_two', 'el trigger de compatibilidad permanece activo');
...
select results_eq(
  'select max_members from public.relationships limit 0',
  'select 2::smallint limit 0',
  'max_members se conserva como metadato de compatibilidad'
);
