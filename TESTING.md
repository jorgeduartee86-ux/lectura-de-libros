...
- 21 comprobaciones pgTAP de esquema/privilegios/RLS sobre el esquema desplegado, más un fixture transaccional de aislamiento entre relaciones, unread, recibos y cancelación de avisos. Las comprobaciones temporales se revierten. La migración 008 elimina permisos EXECUTE directos que algunos entornos Supabase conceden por defecto, además de revocar PUBLIC; la revisión CI detectó esta diferencia entre una instalación nueva y el proyecto existente.
